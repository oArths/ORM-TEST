    ...
    <Modal
      ...
      children={
        <S.Container>
          ...
          <S.ContainerNav>
            <S.OptionsWrap>
              <S.Options onClick={Close} href="#inicio">
                Início
              </S.Options>
              <S.Options onClick={Close} href="#QuemSomos">
                Quem Somos
              </S.Options>
              <S.Options onClick={Close} href="#Sevicos">
                Serviços
              </S.Options>
              <S.Options onClick={Close} href="#Ecossistema">
                Ecossistema
              </S.Options>
              <S.Options onClick={Close} href="#Contato">
                Contato
              </S.Options>
            </S.OptionsWrap>
          </S.ContainerNav>
