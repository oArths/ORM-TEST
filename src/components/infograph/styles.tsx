...
import {backGoundMobile} from "../../assets/index"
...
export const ContainerBar = styled.div`
  ...
  @media (min-width: ${({ theme }) => theme.breakpoint.mobileL}) and 
      (max-width: ${({ theme }) => theme.breakpoint.MobileGG}) {
        right: -185px;
        bottom: 10px;
        gap: 5px;
      }
...
z-index: 6;
  ...
  @media (min-width: ${({ theme }) => theme.breakpoint.MobileGG}) and 
      (max-width: ${({ theme }) => theme.breakpoint.tablet}) {
        left: -220px;
        top:-10px;
        gap: 5px;
...
export const SubTitle = styled.p`
  width: 150px;
  font-size: clamp(0.638rem, 1.5vw, 1.2rem);
  color: ${({ theme }) => theme.colors.neutral100};
  ${({ theme }) =>
    css`
  ...
  /* @media (width >= ${({ theme }) => theme.breakpoint.laptop}) {
    font-size: 0.938rem;
  } */
`;
...
width: 100%;
height: 100%;
background-image: url(${backGoundMobile});
background-position: center;
background-repeat: no-repeat;
background-size: contain;
@media ((min-width: ${({ theme }) => theme.breakpoint.mobileL})and (max-width: ${({ theme }) => theme.breakpoint.mobileG})) {
  gap: 315px;
